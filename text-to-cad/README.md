...
```
![](https://github.com/earthtojake/text-to-cad/raw/main/benchmarks/benchmark_02_circular_flange.gif)
...
Export as a STEP file.
```
![](https://github.com/earthtojake/text-to-cad/raw/main/benchmarks/benchmark_03_l_bracket.gif)
